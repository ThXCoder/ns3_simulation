...
// friend std::ostream& operator<<(std::ostream& os, const LrWpanPhyEnumeration& state);
// friend std::ostream& operator<<(std::ostream& os, const TracedValue<LrWpanPhyEnumeration>& state);
...
{
    FIFO = 0x00,
    MaxPeakWithoutRAZ = 0x01,
    MaxPeakRAZ = 0x02,

} SatelliteReceptionMode;
...
// mousaab
typedef Callback<void, LrWpanPhyEnumeration, uint8_t, double, double, double>
    PlmeEdConfirmCallback_V2;
...
class LrWpanPhy : public SpectrumPhy
{
  public:
    ...
    void SetSatelliteReceptionMode(SatelliteReceptionMode SatelliteRxMode);
    ...
    /*
     * satellite =1
     * simple LrwPan node = 0
     *
     */

    uint8_t* m_attachedAdresse;
    uint32_t m_PrnChannel;
    int m_isSatellite;

    int m_GPSstate;

    double m_MaxGpsSignalPeak;
    uint32_t m_PrnOfMaxPeak;
    double m_Correlation;
    double m_InterferenceAvg;
    Ptr<SpectrumSignalParameters> m_spectrumSatelliteRxParams;
    double m_AbsolutPower;
    SatelliteReceptionMode m_SatelliteRxMode;
    /**
    ...
    Ptr<SpectrumValue> GetTxPowerSpectralDensity(void) const;
    /**
    ...
    void StartSatelliteRx(Ptr<SpectrumSignalParameters> params);
    ...
    void PlmeSatelliteEdRequest(Time, Ptr<SpectrumSignalParameters>);
    ...
    // mousaab
    void SetPlmeEdConfirmCallback_V2(PlmeEdConfirmCallback_V2 c);
  ...
  private:
    ...
    Ptr<SpectrumValue> m_interferenceAndNoise;
    /**
    ...
    // mousaab
    PlmeEdConfirmCallback_V2 m_plmeEdConfirmCallback_V2;
    ...
    Ptr<LrWpanInterferenceHelper> m_SatelliteSignal;
    ...
    EventId m_edSatelliteRequest;
    EventId m_EndRxSatelliteRequest;
    /**
