...
{
    std::cout
        << "\n______________________ AppLayer (SatelliteApp)___________________________________\n";
    ...
    case 2: // Jump to the moon
        Simulator::Schedule(Seconds(0.0),
                            ...
                            RandomMob,
                            drone);
        std::cout << "I am Satellite HERE " << std::endl;
        break;
...
{
    // std::cout<<"OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO\n";
    // std::cout<<"OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO\n";
    // std::cout<<"OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO\n";
    ...
    // BM std::cout<<"time :" << Simulator::Now ().GetSeconds ()<<"\n";

    /****************************recuperation du current
     * device*********************************************/
    // Edited by Tahar
    // Ptr<LrWpanNetDevice> dev = CreateObject<LrWpanNetDevice>();
    Ptr<LrWpanNetDevice> dev = (GetNode())->GetLrWpanNetDevice(0);
    // dev = (GetNode())->GetLrWpanNetDevice(0);

    // dev = ((LrWpanNetDevice)GetNode())->GetLrWpanNetDevice(0);
    ...
    // std::cout << "Add :" << ((uint8_t)Add[1] & 15) << " " << ((Add[1] >> 4) & 15) << "\n";
    ...
    */
    ...
    // Tahar
    /*
    std::cout << "\n I am here [" << dev->GetMac()->GetShortAddress() << "]";
    std::cout << "\n I am here [" << dev->GetMac() << "]";
    std::cout << "\n P[" << p << "]";
    */
