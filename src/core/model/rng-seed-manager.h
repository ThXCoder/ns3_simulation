...
class RngSeedManager
{
  public:
    ...
    // Used to reset the stream index at the end of each simulation
    // Important to ensure metrics are compared with environment being controlled
    static void ResetStreamIndex();
};
