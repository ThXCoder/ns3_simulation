...
class Node : public Object
{
  public:
    ...
    uint32_t AddLrWpanNetDevice(Ptr<LrWpanNetDevice> device);
    ...
    Ptr<LrWpanNetDevice> GetLrWpanNetDevice(uint32_t index) const;
    std::vector<Ptr<LrWpanNetDevice>> GetALLLrWpanNetDevice() const;
    void AddWpanNetDeviceNeighbors(Ptr<LrWpanNetDevice> LrWpanNetDeviceneighbors);
    /**
  ...
  private:
    ...
    std::vector<Ptr<LrWpanNetDevice>> m_LrWpanNetDevice; //!< Devices associated to this node
    std::vector<Ptr<LrWpanNetDevice>> m_LrWpanNetDeviceNeighbors;
